  ...
  return (
    <div className="flex flex-col space-y-8">
      ...
      <div className="border-b pb-2 flex flex-row justify-between">
        <div>
          <p className="text-neutral-400 text-[14px]">VIX</p>
          <span className={`text-[11px] ${vixColor(vix.price)}`}>{vixLabel(vix.price)}</span>
        </div>
      ...
      <div className="border-b pb-2 flex flex-row justify-between">
        <div>
          <p className="text-neutral-400 text-[14px]">SPX 52W High</p>
          <span className="text-[11px] text-neutral-400">{spx.pctOfHigh.toFixed(2)}% of high</span>
        </div>
        <span className="font-data font-extrabold">${spx.price}</span>
      </div>

      <div className="border-b pb-2 flex flex-row justify-between">
        <p className="text-neutral-400 text-[14px]">10-Yr Yield</p>
      ...
      <div className="border-b pb-2 flex flex-row justify-between">
        <p className="text-neutral-400 text-[14px]">USD Index (DXY)</p>
        <div className="flex flex-col items-end">
      ...
      <div className="border-b pb-2 flex flex-row justify-between">
        <p className="text-neutral-400 text-[14px]">BTC/USD</p>
        <div className="flex flex-col items-end">
      ...
      <div className="border-b pb-2 flex flex-row justify-between">
        <p className="text-neutral-400 text-[14px]">Gold <span>(XAU)</span></p>
        <div className="flex flex-col items-end">
      ...
      <div className="border-b pb-2 flex flex-row justify-between">
        <p className="text-neutral-400 text-[14px]">Oil (WTI)</p>
        <div className="flex flex-col items-end">
